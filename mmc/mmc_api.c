 ...
 *
 ******************************************************************/
int MMC_ReadBlock(u32 blockaddr, u8 * recbuf)
{
 ...
 *
 ******************************************************************/
int MMC_ReadMultiBlock(u32 blockaddr, u32 blocknum, u8 * recbuf)
{
	struct mmc_request request;
	struct mmc_response_r1 r1;
	int retval;
 ...
 *
 ******************************************************************/
int MMC_WriteBlock(u32 blockaddr, u8 * sendbuf)
{
	struct mmc_request request;
	struct mmc_response_r1 r1;
	int retval;
 ...
 *
 ******************************************************************/
int MMC_WriteMultiBlock(u32 blockaddr, u32 blocknum, u8 * sendbuf)
{
	struct mmc_request request;
	struct mmc_response_r1 r1;
	int retval;
