...
extern int MMC_ReadBlock(u32 blockaddr, u8 *recbuf);

/* read multi blocks from MMC/SD card */
extern int MMC_ReadMultiBlock(u32 blockaddr, u32 blocknum, u8 *recbuf);
 
/* write a block to MMC/SD card */
extern int MMC_WriteBlock(u32 blockaddr, u8 *recbuf);

/* write multi blocks to MMC/SD card */
extern int MMC_WriteMultiBlock(u32 blockaddr, u32 blocknum, u8 *recbuf);
